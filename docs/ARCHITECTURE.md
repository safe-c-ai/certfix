...
This document describes the public v0.2.0 release implementation. The default
...
certfix v0.2.0 uses a bundled compact catalog of 115 CERT-C rule targets. See
...
The v0.2.0 public path does not expose `llama-cpp-python` or other in-process
GGUF loading.
